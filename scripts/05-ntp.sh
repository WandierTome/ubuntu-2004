...
#
# Script de instalação do NTP Server e Client no GNU/Linux Ubuntu Server 24.04.x
...
echo
#
echo -e "Instalação do NTP Server e Client no GNU/Linux Ubuntu Server 24.04.x\n"
