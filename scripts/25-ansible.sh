...
#
# Script de instalação do Ansible e do Rundeck no GNU/Linux Ubuntu Server 24.04.x
...
echo
#
echo -e "Instalação do Ansible e do Rundeck no GNU/Linux Ubuntu Server 24.04.x\n"
