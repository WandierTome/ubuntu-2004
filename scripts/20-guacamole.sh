...
#
# Script de instalação do Apache Guacamole Server e Client no GNU/Linux Ubuntu Server 24.04.x
...
echo
#
echo -e "Instalação do Apache Guacamole Server e Client no GNU/Linux Ubuntu Server 24.04.x\n"
