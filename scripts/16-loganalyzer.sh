...
#
# Script de instalação do LogAnalyzer no GNU/Linux Ubuntu Server 24.04.x
...
echo
#
echo -e "Instalação e Configuração do LogAnalyzer no GNU/Linux Ubuntu Server 24.04.x\n"
