...
#
# Script de instalação e configuração do Tomcat9 no GNU/Linux Ubuntu Server 24.04.x
...
echo
#
echo -e "Instalação e Configuração do Apache Tomcat9 no GNU/Linux Ubuntu Server 24.04.x\n"
