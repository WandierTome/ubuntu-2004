...
#
# Script de instalação e configuração do LAMP-Server no GNU/Linux Ubuntu Server 24.04.x
...
echo
#
echo -e "Instalação e configuração do LAMP-SERVER no GNU/Linux Ubuntu Server 24.04.x\n"
