...
#
# Script de instalação do PostgreSQL e PgAdmin4 no GNU/Linux Ubuntu Server 24.04.x
...
echo
#
echo -e "Instalação do PostgreSQL e do PgAdmin4 no GNU/Linux Ubuntu Server 24.04.x\n"
