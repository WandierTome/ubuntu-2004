...
#
# Script de instalação do Bacula Server e do Baculum WEB/API no GNU/Linux Ubuntu Server 24.04.x
...
echo
#
echo -e "Instalação do Bacula Server e do Baculum WEB/API GNU/Linux Ubuntu Server 24.04.x\n"
