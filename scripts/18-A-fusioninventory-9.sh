...
#
# Script de instalação do FusionInventory Server e Agent no GNU/Linux Ubuntu Server 24.04.x
...
echo
#
echo -e "Instalação e Configuração do FusionInventory no GNU/Linux Ubuntu Server 24.04.x\n"
