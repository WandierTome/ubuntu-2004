...
Versão: 0.2<br>
Testado e homologado no Raspberry Pi 3 B e Ubuntu Server 24.04.x LTS ARM x64 Bits

26/08/2021 - Lançamento da versão do Ubuntu 24.04.3 LTS: https://wiki.ubuntu.com/FocalFossa/ReleaseNotes/ChangeSummary/24.04.3<br>
26/08/2021 - Release Ubuntu Desktop and Server: https://releases.ubuntu.com/24.04/

#Instalação do Ubuntu Server 24.04.x LTS ARM x64 Bits

#01_ Software para a gravação das imagens no microSD Card<br>

	_ RPI-Manager: https://www.raspberrypi.org/software/

#02_ Download da Imagem do Ubuntu Server 24.04.x LTS ARM x64 Bits
...
#04_ Gravando a imagem do Ubuntu Server no SD Card
	...
	_ Botão direito do mouse na imagem: ubuntu-24.04.3-preinstalled-server-arm64+raspi.img.xz
...
#05_ Ligando o Raspberry Pi 3 B com o microSD Card do Ubuntu Server 24.04.x LTS ARM x64 Bits
