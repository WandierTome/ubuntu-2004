...
#
# Script de instalação do Tftpd-Hpa Server e Client no GNU/Linux Ubuntu Server 24.04.x
...
echo
#
echo -e "Instalação do Tftpd-Hpa Server e Client no GNU/Linux Ubuntu Server 24.04.x\n"
