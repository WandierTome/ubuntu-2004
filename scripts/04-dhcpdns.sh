...
#
# Script de integração do ICS DHCP Server com Bind DNS Server no GNU/Linux Ubuntu Server 24.04.x
...
echo
#
echo -e "Integração do ICS DHCP Server com Bind DNS Server no GNU/Linux Ubuntu Server 24.04.x\n"
